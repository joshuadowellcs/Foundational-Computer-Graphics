...
// If the ray intersects and object, we compute the intersection point using this information.
...
// sphere at the intersection point, else we return the background colro
//[comment]
